...
def scene_two():
    ...
    if nap_or_die.lower().strip() == "climb":
        ...
        "she can see. With the speed of a skilled little monkey she flyes "
        "up branch after branch.")
        ...
        "on her journey, filled with the magic powers a nap gives you.\n")
        time.sleep(1)
        scene_three()
    else:
        print("Did you maybe misspell one of the choices? Lets try again...\n")
...
def scene_three():
    ...
    "At this point of our adventure, her tummy was growling like a grizzly "
    "bear because she hadent eaten for hours.")
    print("She looked at the berries. Some of them she recognized, she "
    "remembered her kindergarden teacher showing them as berries you can eat.")
    ...
    if berries_or_be_burried.lower().strip() == "recognize":
        ...
        "for herself. With some newfound energy she felt ready to embark on "
        "her adventure.\n")
        scene_four()
...
def scene_four():
    ...
    if snakes_on_a_path == "confront":
        ...
        "question correct, deal?'. Petra noded like she's never noded before.")
...
def scene_five():
    ...
    if pond_pondering.lower().strip() == 'bath':
        ...
        if surly_curly.lower().strip() == "{}":
            ...
            "the other sideof the pond, i can eat him.' said the snake and "
            "swam away.")
...
def scene_six():
    ...
    if hardknock_life.lower().strip() == "knock":
        ...
        "said: 'Hey there mister, its getting late and im a long way from "
        "home...")
        ...
        if stranger_danger.lower().strip() == "yes":
            ...
            "husband George. And after we have eating we can walk with you "
            "home.")
            ...
            "took a walk home to Petras house, it only took about 10minutes.")
