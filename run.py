...
def scene_five():
    ...
    if pond_pondering.lower().strip() == 'bath':
        ...
        if surly_curly.lower().strip() == "{}":
            ...
            print("Petra cooled off at the pond for a little while and then continued her journey.\n")
            scene_six()
        ...
        time.sleep(1)
        print("Petra thought about it for a second but decided to continue on her adventure, time is precious you know")
        time.sleep(1)
        scene_six()
    else:
        print("Did you maybe misspell one of the choices? Lets try again...\n")
...
# Start of scene six
def scene_six():
    print("After walking for a while, Petra comes across a small cabin in the woods. It has began to get pretty late and the sky is getting darker by the minute.")
    print("She thought for herself 'It's getting close to bedtime, maybe i should knock on this door and see if they can give me a ride home?")
    print("And then she thought: '...then again what adventure would that be? Maybe i'll just continue?")
    hardknock_life = input("Should Petra 'Knock' on the door or 'Continue'? ")
    if hardknock_life.lower().strip() == "knock":
        time.sleep(1)
        print("Petra knocks on the door. After a couple of seconds a old man opens.. 'Who it is'? said a raspy, irritated voice.")
        print("Petra was a little restricted to strangers, as kids should be, said: 'Hey there mister, its getting late and im a long way from home...")
        print("'...could you give me a ride home?' she said with a somewhat squeaky voice.")
        print("The old man turned and yelled 'Hey Barbra, we got a little visitor!'")
        print("And from somewhere inside Petra could hear a ladys voice 'Oh George what are you yelling about now?'")
        print("The old lady stepped up to Petra and said 'Now look at you, what a sweet little girl, are you hungry?'")
        print("And Petra was hungry, had been a while since she ate them berries. But eating dinner at strangers?")
        stranger_danger = input("Should Petra eat dinner at the strangers? 'Yes' or 'No' ")
        if stranger_danger.lower().strip() == "yes":
            time.sleep(1)
            print("'Yes mam, im hungry' said Petra. And the old lady reply 'Of course you are dear. Come in, we're having hot dogs'.")
            print("The old lady continued 'My name is Barbra and this is my husband George. And after we have eating we can walk with you home.")
            print("The hot dogs were delicous and Petra must have eating 10 of them.")
            print("After dinner Petra and her new friends George and Barbra took a walk home to Petras house, it only took about 10minutes.")
            print("Turns out Petras long adventure only took her to the end of the street.")
            print("Guess the moral of the story is: You dont have to look far for adventure, life is a big adventure in it self.")
            time.sleep(2)
            print(f"Well played {name}! Thanks to you Petra had a magic day and got home safe and sound.")
            print("Thank you for playing my adventure game, you rock! TBH i never thought you would make it.")
            print(f"One last thing, {name}... naa, nevermind. It wasent anything important anyway.")
            game_over = input("Want to play again? 'Yes or No': ")
        if game_over.lower().strip() == "yes":
            time.sleep(2)
            scene_one()
        ...
        print("'Hell no, stranger danger!' Petra said to herself and walked past the cabin.")
        print("After walking just a couple of minutes it had gotten even darker.")
        print("Every little adventurer needs to know when its time to call it quits.")
        print("Petra reached down her pocket and picked up her brand new cellphone.")
        print("'Mommy, daddy, can you come and pick me up! I'm just past the big old cabin down the road' Petra said.")
        print("'Of course, honey' her mom replied.")
        print("Soon Petra was home, safe and sound. Her dad gave her some hot dogs he just had made, they were delicous.")
        time.sleep(2)
        print(f"So you dident have the guts to knock on the cabindoor, did you {name}?")
        print("But you did get Petra home safe and safe, which is all that matters!")
        print(f"So congrats {name}, you finished my adventure game like a champion! (Kinda)")
        game_over = input("Want to play again? 'Yes or No': ")
        if game_over.lower().strip() == "yes":
            time.sleep(2)
            scene_one()
